...
@section('content')
    ...
    <div class="widget">
        ...
        <table id="checkAll" class="sTable mTable myTable" cellspacing="0" cellpadding="0" width="100%">
            ...
            <tr>
                <td style="width:21px;">
                    <img src="{{ asset('contents/images/icons/tableArrows.png') }}">
                </td>
            ...
            @foreach($categories as $position => $category)
                ...
                <tr class="row_9">
                    ...
                    <td class="textC">{{ $category->hasParent() ? $category->parent->name : '-' }}</td>
